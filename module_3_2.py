...
def send_email(message, recipient, *,sender = "university.help@gmail.com"):
    ...
    sender_flag = False
    len_rec = len(recipient)-4  #просто чтобы не разгрузить код дальше
...
#Тестовые сообщения
send_email('Test', 'blabla.ru.net.com', sender = 'bla@.net.com.ru')
send_email('Test', 'bla@.ru.net.com', sender = 'bla@.net.com.ru')
send_email('Test', 'blabla@.ru.net.com.uk', sender = 'bla@.net.com.ru')
send_email('Test', 'blabla@.ru.net.uk.com', sender = 'bla@.net.com.ru')